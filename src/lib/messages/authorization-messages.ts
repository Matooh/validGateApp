export const AUTHORIZATION_MESSAGE_TEXT = {
  ...
  EXIT_AUTHORIZATION_REQUIRED: 'Se requiere autorización vigente del apoderado.',
  ...
  STUDENT_EXIT_NOT_ALLOWED_ALONE:
    'No estás autorizado para registrar salida directa. Solicita autorización de apoderado o responsable.',
